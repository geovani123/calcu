...
function Resolver (operador)
{
	...
	switch (operador)
	{
		...
		case '-':
				...
				break;
		case '*':
				document.getElementById("operador").src="imagenes/multiplicacion.png"
				R[0]=F1[0]*F2[1];
				R[1]=F1[1]*F2[1];
				break;
		case '/':
				document.getElementById("operador").src="imagenes/division.png"
				R[0]=F1[0]*F2[1];
				R[1]=F1[1]*F2[1];
				break;
		case 'b':
				document.getElementById("operador").src="imagenes/borrar.jpg"
